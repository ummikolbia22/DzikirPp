...
import com.ummi.dzikirpp.adapterpagi.AdapterPagi
...
class DzikirPagi : AppCompatActivity() {
    ...
    private val slideAdapter = AdapterPagi(
        listOf(
            DataDzikirPagi(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewPagerPagi.adapter = slideAdapter

        setUpIndicators()

        setCurrentIndicators(0)

        viewPagerPagi.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
    ...
    private fun setCurrentIndicators(index: Int) {
        val childCount = dotsPagi.childCount

        for (i in 0 until childCount) {
            val imageView = dotsPagi.get(i) as ImageView
